...
class AuthenticationBloc
  ...
  AuthenticationBloc({this.user})
    ...
    on<LoginWithEmailAndPasswordEvent>((event, emit) async {
      ...
      try {
        result = await FireStoreUtils.loginWithEmailAndPassword(
          event.email, event.password);
        print('Login Result: $result');
      } catch (e) {
        print('Unknown error occurred during authentication: $e');
        result = null; // Set the result to null in case of an unknown error
      }
